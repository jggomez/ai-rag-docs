...
- [x] T008 [US1] Implement `POST /ingest` endpoint in `src/ingestion-pipeline/src/main.py`
- [ ] T009 [US1] Create unit tests for `/ingest` endpoint in `tests/test_api_ingest.py`
...
- [ ] T014 [US3] Verify metadata persistence in Firestore using a test document
